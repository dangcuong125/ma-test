...
export default function ProductDetailContainer(){
  ...
  const {data_ProductDetail, isLoading } = useGetDetailProd(parseInt(params?.id as string));
  const data_DETAIL =  data_ProductDetail?.items?.find((item: any) =>  parseInt(params?.id as string) === item?.id ) ;
  const breadcrumbs = [
