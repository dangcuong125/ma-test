...
import { Grid, Stack, Typography, Input, Breadcrumbs, Link, Box, Pagination, Divider, Button } from "@mui/material";
            ...
            <Stack spacing={2}>
                ...
                <Grid container spacing={4}  height={'100%'} width={"100% !important"}>
                    ...
                    <Pagination count={10} sx={{
                        display: "flex", justifyContent: "center", paddingY: "50px", width: "100%", '& .css-lxelle-MuiButtonBase-root-MuiPaginationItem-root.Mui-selected': {
